...
console.log('\n4. Usando Array.prototype.forEach:');
Array.from({ length: 10 }, (_, i) => i + 1).forEach((num) => console.log(num));
...
console.log('\n7. Usando Array.prototype.map:');
Array.from({ length: 10 }, (_, i) => i + 1).map((num) => console.log(num));

// 8. Usando Array.prototype.reduce
console.log('\n8. Usando Array.prototype.reduce:');
Array.from({ length: 10 }, (_, i) => i + 1).reduce((_, num) => {
  console.log(num);
  return null;
}, null);
...
console.log('\n9. Usando Array.prototype.every:');
Array.from({ length: 10 }, (_, i) => i + 1).every((num) => {
  console.log(num);
  return true;
});
